...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    #
    # Immagino che sia possibile sovrascrivere il metodo send, quindi chiamando send potrebbe essere
    # che richiamo una funzionalità completamente differente da quella di cui ho bisogno.
    # Quindi per essere sicuro che sia la funzionalità che voglio c'è il metodo __send__
    #
    #
  end
