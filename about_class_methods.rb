...
class AboutClassMethods < Neo::Koan
  ...
  #
  #
  # Io credo che class << self si debba utilizzare quando ho molti metodi da definire all'interno di una classe
  # questo permetterebbe una miglior leggibilità del codice e una separazione più evidente dei
  # class_methods dagli instance_methods.
  # In più la definizione dei metodi privati è più pratica ed è relativa solo al blocco class << self
  #
  #
  # ------------------------------------------------------------------
