...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    #
    # maintain variable through the loop  and assign the value of the function expressed
  end
  ...
  #
  # Perchè lo chiudo in un blocco e quindi l'apertura del file viene
  # chiusa automaticamente alla fine del blocco
